                ...
                <div class="topbar-actions">
                    <div class="topbar-profile" data-bs-toggle="modal" data-bs-target="#profileModal">
                        <div class="topbar-identity">
                            ...
                            <div>Adviser | College of Technology</div>
                        </div>
...
<script>
    ...
    function openInstructorNotification(notificationId) {
        ...
        window.requestAnimationFrame(() => {
            if (type.includes('section') || type.includes('request') || type.includes('enroll') || type === 'org_req') {
                highlightNotificationTarget(
                    notification.reference_id
                        ? `[data-request-id="${notification.reference_id}"]`
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ${pendingSectionRequests.map(req => {
                                ...
                                return `
                                <tr data-request-id="${req.request_id}" data-student-id="${req.student_id}">
                                    <td>
