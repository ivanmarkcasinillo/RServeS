...
<div class="d-flex" id="wrapper">
    ...
    <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" onclick="showView('orgs', this)">
                <span><i class="fas fa-building"></i> Organizations</span>
                <?php if($total_pending_org > 0): ?>
                    <span class="badge bg-danger rounded-pill"><?php echo $total_pending_org; ?></span>
                <?php endif; ?>
            </a>
